        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                {NAV_LINKS.map((link) => (
                  <li key={link.id}>
                    ...
                    className="group flex items-center gap-2 text-white/60 hover:text-primary transition-all duration-300">
                      ...
                      <span className="text-sm">{link.lable}</span>
                    </button>
                  </li>
                ))}
              </ul>
          ...
          <FadeIn delay={200}>
            <div>
              ...
              <p className="text-white/60 text-sm mb-6 leading-relaxed">Let's connect and create something amazing together.</p>
        ...
        <FadeIn delay={300}>
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <p className="flex items-center gap-2 text-white/50 text-sm">Built with <Heart className="w-4 h-4 text-primary fill-primary animate-pulse" /> using React & Tailwind CSS</p>
            </div>
          </div>
        </FadeIn>
      </div>
