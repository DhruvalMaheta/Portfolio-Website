...
import { SiReact, SiNextdotjs, SiTailwindcss, SiNodedotjs, SiMongodb, SiMysql } from "react-icons/si";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8">Building modern , scalable web applications with React, JavaScript and cutting-edge technologies. Transforming ideas into exceptional digital experiences.</p>
            </FadeIn>
            ...
            <FadeIn delay={300}>
              <button
                ...
                <div className="relative z-10 bg-white text-[#212121] rounded-[17px] px-[26px] py-[13px] text-base font-medium border border-white">Get in Touch</div>
              </button>
            </FadeIn>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group">
                ...
                <div className="relative rounded-2xl overflow-hidden m-[1px] h-[calc(100%-2px)]">
                  <img src="/developer.jpg" alt="Developer at work" className="w-full h-full object-cover" />
                </div>
