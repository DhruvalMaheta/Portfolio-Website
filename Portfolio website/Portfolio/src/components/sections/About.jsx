...
import {SiReact , SiNextdotjs , SiTypescript , SiTailwindcss,SiNodedotjs,SiMongodb,SiMysql} from 'react-icons/si';
      ...
      <FadeIn delay={500}>
        <div className= "flex flex-col items-center gap-8">
          <div className= "text-center">
            ...
            <p className= "text-sm text-white/60">Technologies I work with to build amazing products.</p>
          </div>
